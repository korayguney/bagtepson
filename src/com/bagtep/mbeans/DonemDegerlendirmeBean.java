...
public class DonemDegerlendirmeBean {
	...
	public String degerlendirmeKaydet() {
		...
		donemDegerlendirmeService.degerlendirmeKaydet(ogrenciId, dersAd, degerlendirici, ozelAmaclarMap, ozelAmacYorum,
				ozelAmacIdMap, ozelAmaclarMapEK, ozelAmacYorumEK, ozelAmacIdMapEK);
		donemDegerlendirmeService.degerlendirmePuanKaydet(ogrenciId, dersAd);
		FacesContext.getCurrentInstance().addMessage(null,
				new FacesMessage(FacesMessage.SEVERITY_INFO, "", "Dönem Değerlendirme Başarıyla Kaydedildi !!!"));
		
			return "sdsadsadsadasd";
	}

	public String degerlendirmePuanGuncelle(double puan){
		donemDegerlendirmeService.degerlendirmePuanKaydet(ogrenciId, dersAd);
		FacesContext.getCurrentInstance().addMessage(null,
				new FacesMessage(FacesMessage.SEVERITY_INFO, "", "Puan güncellendi!!"));
		return dersAd;
	}
	...
	public boolean dahaOnceDonemDegerlendirilmismi() {

		boolean result = donemDegerlendirmeService.dahaOnceDonemDegerlendirilmismi(ogrenciId, dersAd);
		return result;
	}

	public boolean dahaOnceKabaDegerlendirmeRaporuOlusturulmusmu() {

		boolean result = donemDegerlendirmeService.dahaOnceBireyselEgitimPlaniOlusturulmusmu(ogrenciId, dersAd);
		return result;
	}	
