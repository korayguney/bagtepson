...
public class DonemDegerlendirmeGoruntuleBean {
	...
	public void init() {
		...
		donemDegerlendirme = donemDegerlendirmeService.donemDegerlendirmeGetir2(ogrenciId, dersId);
		List<DonemDegerlendirmeKazanimCevap> donemDegerlendirmeKazanimCevap = donemDegerlendirme
				.getDonemDegerlendirmeKazanimCevap();
		...
		if (dersAd.equals("Matematik")) {
			...
			for (OzelAmac o : this.ozelAmacBEPteSecilen) {
				this.ozelAmaclarMap.put(o.getId(),
						o.getDonemDegerlendirmeKazanimCevap().iterator().next().getDonemDegerlendirmeCevap());
			}
			...
			for (OzelAmacEK o : this.genelAmac.getOzelAmaclarEK()) {
				this.ozelAmacYorumEK.put(o.getId(), o.getDonemDegerlendirmeKazanimCevap().iterator().next().getYorum());
			}
	...
	public String degerlendirmeGoruntuleKaydetAdmin() {
		...
		donemDegerlendirmeService.degerlendirmeGoruntuleKaydet(ogrenciId, dersAd, degerlendirici, ozelAmaclarMap,
		...
		return "adminDonemDegerlendirmeGoruntuleOgrenciSec";
	}
	...
	public String degerlendirmeGoruntuleKaydetOgretmen() {
		...
		FacesContext.getCurrentInstance().addMessage(null,
				new FacesMessage(FacesMessage.SEVERITY_INFO, "", "Dönem Değerlendirme Başarıyla Düzenlendi !!!"));
		return "ogretmenDonemDegerlendirmeGoruntuleOgrenciSec";
	}
