...
public class YilSonuDegerlendirmeGoruntuleBean {
	...
	public void init() {
		...
		yilSonuDegerlendirme = yilSonuDegerlendirmeService.yilSonuDegerlendirmeGetir2(ogrenciId, dersId);
		List<YilSonuDegerlendirmeKazanimCevap> yilSonuDegerlendirmeKazanimCevap = yilSonuDegerlendirme
				.getYilSonuDegerlendirmeKazanimCevap();
		...
		if (dersAd.equals("Matematik")) {
			...
			for (OzelAmac o : this.ozelAmacBEPteSecilen) {
				this.ozelAmaclarMap.put(o.getId(),
						o.getYilSonuDegerlendirmeKazanimCevap().iterator().next().getYilSonuDegerlendirmeCevap());
			}

			for (OzelAmacEK o : this.genelAmac.getOzelAmaclarEK()) {
				this.ozelAmaclarMapEK.put(o.getId(),
						o.getYilSonuDegerlendirmeKazanimCevap().iterator().next().getYilSonuDegerlendirmeCevap());
			}
			...
			for (OzelAmacEK o : this.genelAmac.getOzelAmaclarEK()) {
				this.ozelAmacYorumEK.put(o.getId(), o.getYilSonuDegerlendirmeKazanimCevap().iterator().next().getYorum());
			}
	...
	public String degerlendirmeGoruntuleKaydetAdmin() {
		...
		yilSonuDegerlendirmeService.degerlendirmeGoruntuleKaydet(ogrenciId, dersAd, degerlendirici, ozelAmaclarMap,
				ozelAmacYorum, ozelAmacIdMap, ozelAmaclarMapEK, ozelAmacYorumEK, ozelAmacIdMapEK);
		FacesContext.getCurrentInstance().addMessage(null,
				new FacesMessage(FacesMessage.SEVERITY_INFO, "", "Yıl Sonu Değerlendirme Başarıyla Düzenlendi !!!"));
		return "adminYilSonuDegerlendirmeGoruntuleOgrenciSec";
	}
	...
	public String degerlendirmeGoruntuleKaydetOgretmen() {
		...
		FacesContext.getCurrentInstance().addMessage(null,
				new FacesMessage(FacesMessage.SEVERITY_INFO, "", "Yıl Sonu Değerlendirme Başarıyla Düzenlendi !!!"));
		return "ogretmenYilSonuDegerlendirmeGoruntuleOgrenciSec";
	}
	...
	public String degerlendirmeTarihiFormatla() {
		...
		Date ysdtarihi = getDegerlendirmeTarihi();
		SimpleDateFormat DATE_FORMAT = new SimpleDateFormat("dd-MM-yyyy");
		String date = DATE_FORMAT.format(ysdtarihi);
